...
export const useAddDigitalSecurity = () => {
  ...
  return useMutation(
    (getEquityDetailsRequest: GetSecurityDetailsRequest) =>
      SDKService.getSecurityDetails(getEquityDetailsRequest),
    {
      onSuccess: (data) => {
        if (
          holderSecurities[walletAddress]?.some(
            (security: AccountData) => security.address === data.diamondAddress,
          )
        ) {
          ...
          toast.show({
            ...
            description: `${t("messages.additionSucces")} ${
              data.diamondAddress
            }`,
            variant: "subtle",
            status: "success",
          ...
          if (
            !securities.some(
              (securityStore: SecurityStore) =>
                securityStore.address === security.address,
            )
          ) {
